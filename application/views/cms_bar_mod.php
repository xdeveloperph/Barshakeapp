<div class="row">
    <div class="col-md-6 col-md-offset-3">
        ...
        echo form_open(base_url().'cms/bars/'.$action."/".$reference,$attributes,$hidden);
        ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="user[street]" id="user[street]" placeholder="Street Address" value="<?php if(isset($data[0]['street'])) echo $data[0]['street'];   ?>" required>
        </div>
        <div class="form-group">
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAUwWL8t5TF0FvNXzz3OGuUMdVouCQqizU&signed_in=true&callback=initMap"></script>